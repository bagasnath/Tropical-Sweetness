  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <br><br><br>
                <li class="active"><a href="user.php"> <i class="icon-home"></i>User </a></li>
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Tabel User</h2>
          </div>
        </div>
        <br>
                  ...
                  <div class="table-responsive"> 
                    <table class="table">
                      ...
                      while($arrayUser = mysqli_fetch_array($queryUser)){
                        echo '
                          <tr>
                            <td>'.$arrayUser['namaUser'].'</td>
                            <td>'.$arrayUser['telpon'].'</td>
                            <td>'.$arrayUser['email'].'</td>
                            <td>'.$arrayUser['alamat'].'</td>
                            <td><a href="proses/hapusUser.php?idUser='.$arrayUser['idUser'].'">
